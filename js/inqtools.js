$(function() {
    ...
    $('#romap').mapWidget({
        validate: function(e, hit) {
            //console.log(hit.map, hit.region);
        },
        click: function(e, hit) {
            var o = $(this).mapWidget('option','maps');
            var value = $(this).mapWidget('value');
            var ret = [];
            for (var k in value) {
                if (o[k].config.name && value[k]) {
                    ret.push(o[k].config.name);
                }
            }
            $('#chosen').html(ret.join('<br>'));
        ...
        maps: {
            ...
            'syrtis-iz':{
                config:{image:'ROMapImage syrtis-iz',hidden:true,name:"Syrtis Initiation Zone"},
                areas:{
            ...
            'syrtis-ir':{
                config:{image:'ROMapImage syrtis-ir',hidden:true,name:"Syrtis Inner Realm"},
                areas:{
            ...
            'syrtis-wz':{
                config:{image:'ROMapImage syrtis-wz',hidden:true,name:"Syrtis War Zone"},
                areas:{
            ...
            'ignis-iz':{
                config:{image:'ROMapImage ignis-iz',hidden:true,name:"Ignis Initiation Zone"},
                areas:{
            ...
            'ignis-ir':{
                config:{image:'ROMapImage ignis-ir',hidden:true,name:"Ignis Inner Realm"},
                areas:{
            ...
            'ignis-wz':{
                config:{image:'ROMapImage ignis-wz',hidden:true,name:"Ignis War Zone"},
                areas:{
            ...
            'alsius-iz':{
                config:{image:'ROMapImage alsius-iz',hidden:true,name:"Alsius Initiation Zone"},
                areas:{
            ...
            'alsius-ir':{
                config:{image:'ROMapImage alsius-ir',hidden:true,name:"Alsius Inner Realm"},
                areas:{
            ...
            'alsius-wz':{
                config:{image:'ROMapImage alsius-wz',hidden:true,name:"Alsius War Zone"},
                areas:{
