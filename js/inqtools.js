$(function() {
    ...
    $('#pets_region_map').mapWidget({
        ...
        maps: {
            ...
            'syrtis-iz':{
                config:{image:'ROMapImage syrtis-iz',name:"Syrtis Initiation Zone"},
                areas:{
            ...
            'syrtis-ir':{
                config:{image:'ROMapImage syrtis-ir',name:"Syrtis Inner Realm"},
                areas:{
            ...
            'syrtis-wz':{
                config:{image:'ROMapImage syrtis-wz',name:"Syrtis War Zone"},
                areas:{
            ...
            'ignis-iz':{
                config:{image:'ROMapImage ignis-iz',name:"Ignis Initiation Zone"},
                areas:{
            ...
            'ignis-ir':{
                config:{image:'ROMapImage ignis-ir',name:"Ignis Inner Realm"},
                areas:{
            ...
            'ignis-wz':{
                config:{image:'ROMapImage ignis-wz',name:"Ignis War Zone"},
                areas:{
            ...
            'alsius-iz':{
                config:{image:'ROMapImage alsius-iz',name:"Alsius Initiation Zone"},
                areas:{
            ...
            'alsius-ir':{
                config:{image:'ROMapImage alsius-ir',name:"Alsius Inner Realm"},
                areas:{
            ...
            'alsius-wz':{
                config:{image:'ROMapImage alsius-wz',name:"Alsius War Zone"},
                areas:{
